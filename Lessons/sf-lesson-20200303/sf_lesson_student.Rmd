...
my_tabular_data_raw <- read.csv(here("data", "tabular_data", "gagesII_sept30_2011_tabular.csv"))
...
unique(colnames(basins_nf_seplains_raw))
unique(col(basins_nf_seplains_raw))
...
# Separating out data frame and geometry
...
# add your code here
NC <- southeast_state_bounds %>% filter(STUSPS == "NC")
# check
# add your code here
head(NC)
# select watersheds that intersect with NC bounds
# add your code here
NC.watershed <- st_intersects(basins_nf_seplains_raw, NC)
# check
# add your code here
